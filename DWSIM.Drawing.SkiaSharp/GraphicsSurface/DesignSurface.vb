                ...
                If Not gObjTo Is Nothing Then
                    ...
                    Else
                        Select Case gObjFrom.ObjectType
                            ...
                            ObjectType.Filter, ObjectType.CustomUO, ObjectType.CapeOpenUO, ObjectType.FlowsheetUO, ObjectType.External, ObjectType.RCT_Conversion, ObjectType.EnergyMixer, ObjectType.EnergySplitter, ObjectType.EnergySwitch, ObjectType.MaterialSwitch
                                GoTo 100
                            Case Else
                                Throw New Exception("This connection is not allowed.")
                        End Select
100:                    If gObjFrom.ObjectType <> ObjectType.CapeOpenUO And gObjFrom.ObjectType <> ObjectType.CustomUO And gObjFrom.ObjectType <> ObjectType.DistillationColumn _
                        And gObjFrom.ObjectType <> ObjectType.AbsorptionColumn And gObjFrom.ObjectType <> ObjectType.OT_EnergyRecycle And gObjFrom.ObjectType <> ObjectType.External _
                                                    ...
                                                    And gObjFrom.ObjectType <> ObjectType.RCT_Conversion And gObjFrom.ObjectType <> ObjectType.EnergyMixer And gObjFrom.ObjectType <> ObjectType.EnergySplitter And gObjFrom.ObjectType <> ObjectType.EnergySwitch And gObjFrom.ObjectType <> ObjectType.MaterialSwitch Then
