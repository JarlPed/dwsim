...
Namespace UnitOperations
    ...
    <System.Serializable()> Public Class EnergySwitch

        Inherits UnitOperations.UnitOpBaseClass
        Public Overrides Property ObjectClass As SimulationObjectClass = SimulationObjectClass.MixersSplitters

        <NonSerialized> <Xml.Serialization.XmlIgnore> Public f As EditingForm_EnergySwitch
        ...
        Public Overrides Sub Calculate(Optional ByVal args As Object = Nothing)
            ...
            IObj?.Paragraphs.Add("The switch is a energy directing unit operation - the energy 
            ...
            GetInletEnergyStream(0).Validate()

            Dim W As Double = GetInletEnergyStream(0).EnergyFlow


            If MEngine Is Nothing Then
                MEngine = New Mages.Core.Engine()
                bFunc = MEngine.Interpret("( HF ) => " + BooleanExpression)
            End If
            If _ExpressionChanged Then
                _ExpressionChanged = False
                bFunc = MEngine.Interpret("( HF ) => " + BooleanExpression)
            End If
            Dim BoleanVal As Boolean = bFunc.Invoke(New Object() {W})

            ' For material stream switch ... Add this in a hoover over button?
            ...
            '    bFunc = MEngine.Interpret("( T, P, W, M, Q, VF, LF, SF ) => " + BooleanExpression)
            'End If
            'Dim BoleanVal As Boolean = bFunc.Invoke(New Object() {vars})
            ...
            'GraphicObject.UpdateDraw(GraphicObject, BoleanVal)
            If (BoleanVal) Then
        ...
        Public Overrides Sub DisplayEditForm()
            ...
            If f Is Nothing Then
                f = New EditingForm_EnergySwitch With {.SimObject = Me}
        ...
        Public Overrides Function GetIconBitmap() As Object
            Return My.Resources.switch_energy
        End Function

        Public Overrides Function GetDisplayDescription() As String
            Return ResMan.GetLocalString("ENSW_Desc")
        End Function

        Public Overrides Function GetDisplayName() As String
            Return ResMan.GetLocalString("ENSW_Name")
        End Function
