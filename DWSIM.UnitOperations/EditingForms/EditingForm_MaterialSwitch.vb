...
Public Class EditingForm_MaterialSwitch

    Inherits SharedClasses.ObjectEditorForm

    Public Property SimObject As UnitOperations.MaterialSwitch
    ...
    Private Sub EditingForm_MaterialSwitch_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ToolTip2_Popup(sender As Object, e As PopupEventArgs) Handles ToolTip_BoolExp.Popup

    End Sub

    Private Sub Button1_MouseHover(sender As Object, e As EventArgs) Handles Button1.MouseHover

        ToolTip_BoolExp.Show("
            ...
            Otherwise, FALSE will route the Inlet Stream to Outlet Stream 2.
            ", Button1, New System.Drawing.Point(0, Button1.Height + 3))
    End Sub
