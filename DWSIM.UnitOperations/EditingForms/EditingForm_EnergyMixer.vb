...
Public Class EditingForm_EnergyMixer

    Inherits SharedClasses.ObjectEditorForm

    Public Property MixerObject As UnitOperations.EnergyMixer
    ...
    Sub UpdateInfo()
        ...
        With MixerObject
            ...
            If Not .GetInletEnergyStream(0) Is Nothing Then cbInlet1.SelectedItem = .GetInletEnergyStream(0).GraphicObject.Tag
            If Not .GetInletEnergyStream(1) Is Nothing Then cbInlet2.SelectedItem = .GetInletEnergyStream(1).GraphicObject.Tag
            If Not .GetInletEnergyStream(2) Is Nothing Then cbInlet3.SelectedItem = .GetInletEnergyStream(2).GraphicObject.Tag
            If Not .GetInletEnergyStream(3) Is Nothing Then cbInlet4.SelectedItem = .GetInletEnergyStream(3).GraphicObject.Tag
            If Not .GetInletEnergyStream(4) Is Nothing Then cbInlet5.SelectedItem = .GetInletEnergyStream(4).GraphicObject.Tag
            If Not .GetInletEnergyStream(5) Is Nothing Then cbInlet6.SelectedItem = .GetInletEnergyStream(5).GraphicObject.Tag

            If Not .GetOutletEnergyStream(0) Is Nothing Then cbOutlet1.SelectedItem = .GetOutletEnergyStream(0).GraphicObject.Tag
    ...
    Private Sub cbPropPack_SelectedIndexChanged(sender As Object, e As EventArgs)
        If Loaded Then
    ...
    Private Sub cbPressureCalcMode_SelectedIndexChanged(sender As Object, e As EventArgs)

        'If Loaded Then
        '
        '    Select Case cbPressureCalcMode.SelectedIndex
        '        Case 0
        '            MixerObject.PressureCalculation = UnitOperations.EnergyMixer.PressureBehavior.Minimum
        '        Case 1
    ...
    Private Sub btnConfigurePP_Click(sender As Object, e As EventArgs)
    ...
    Private Sub btnCreateAndConnectInlet1_Click(sender As Object, e As EventArgs) Handles btnCreateAndConnectInlet1.Click, btnCreateAndConnectInlet2.Click, btnCreateAndConnectInlet3.Click, btnCreateAndConnectInlet4.Click, btnCreateAndConnectInlet5.Click, btnCreateAndConnectInlet6.Click, btnCreateAndConnectOutlet1.Click
        ...
        ElseIf sender Is btnCreateAndConnectOutlet1 Then
            ...
            Dim obj = fs.AddObject(ObjectType.EnergyStream, sgobj.OutputConnectors(0).Position.X + 30, sgobj.OutputConnectors(0).Position.Y, "")
